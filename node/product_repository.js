...
const SAVE_ONE_QUERY 		= "insert into product (name , threshold_stock, createdBy, createdDate, updatedBy, updatedDate) values( ?, ?, ?, ?, ?, ? ) ";
...
const UPDATE_ONE_QUERY 		= "update product set name = ? , threshold_stock = ? , updatedBy = ? , updatedDate = ? where id = ? ";
